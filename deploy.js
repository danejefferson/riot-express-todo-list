...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../lesson-3-handson',
    '/home/ubuntu/lesson-3-handson-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf lesson-3-handson-temp && mkdir lesson-3-handson-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir lesson-3-handson && cp -r lesson-3-handson-temp/* lesson-3-handson-list/ && rm -rf lesson-3-handson-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd lesson-3-handson && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `lesson-3-handson-temp` folder.');
